...
ALTER TABLE `comment` ADD CONSTRAINT fk_comment_account FOREIGN KEY (account_id) REFERENCES `account`(id);
ALTER TABLE `comment` ADD CONSTRAINT fk_comment_account FOREIGN KEY (book_id) REFERENCES `book`(id);
